...
def objective(trial, config, only_last=False):
    ...
    print(hyperparams["shrinkage"], hyperparams["gamma_1"], hyperparams["gamma_2"], hyperparams["metric_normalization"])
    ...
    if model_type == "KNN":
        ...
        clf = GradKNNClassifier(
            ...
            n_points=min(hyperparams["n_points"], hyperparams['n_clusters']),  # Ensures it respects min(40, n_clusters)
